...
const StudentSidebar = () => (
  <div className="p-4">
    ...
    <ul>
      ...
      <li className="mb-6">
        <Link to="/student/lectures" className="flex items-center space-x-3 text-white text-xl hover:text-blue-900">
          <Video className="w-6 h-6" />
          <span className="text-justify">Lecture Access</span>
        </Link>
      </li>
      <li className="mb-6">
        <Link to="/student/assignments" className="flex items-center space-x-3 text-white text-xl hover:text-blue-900">
          <ClipboardList className="w-6 h-6" />
          <span className="text-justify">Assignments</span>
        </Link>
      </li>
      <li className="mb-6">
        <Link to="/student/quizzes" className="flex items-center space-x-3 text-white text-xl hover:text-blue-900">
          <Pencil className="w-6 h-6" />
          <span className="text-justify">Quizzes & Exams</span>
        </Link>
      </li>
      <li className="mb-6">
        <Link to="/student/grades" className="flex items-center space-x-3 text-white text-xl hover:text-blue-900">
